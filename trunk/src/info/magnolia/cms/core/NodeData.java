...
public class NodeData {
    ...
    /**
     * <p>constructor | create atom object to work-on based on
     * existing <code>NodeData</code><p>
     *
     * @param workingNode current active <code>Node</code>
     * @param name <code>NodeData</code> name to be retrieved
     */
    public NodeData (Node workingNode, String name)
            throws PathNotFoundException, RepositoryException  {
        this.dataFile = workingNode.getNode(name);
        this.property = this.dataFile.getNode
                (ItemType.getSystemName(ItemType.JCR_CONTENT)).getProperty(DATA_ELEMENT);
    }



    /**
     * <p>constructor | creates a new initialized NodeData of default type <b>String</b></p>
     *
     * @param workingNode current active <code>Node</code>
     ...
     */
    public NodeData (Node workingNode, String name, boolean createNew)
            throws PathNotFoundException, RepositoryException  {
        if (createNew) {
            this.dataFile = workingNode.addNode(name, ItemType.getSystemName(ItemType.NT_NODEDATA));
            Node contentNode = this.dataFile.addNode
                    (ItemType.getSystemName(ItemType.JCR_CONTENT),
                            ItemType.getSystemName(ItemType.NT_UNSTRUCTRUED));
    ...
    /**
     * <p>constructor | creates a new initialized NodeData</p>
     *
     * @param workingNode current active <code>Node</code>
     * @param name <code>NodeData</code> name to be created
     ...
     * @see NodeData#NodeData(javax.jcr.Node, java.lang.String, javax.jcr.Value)
     */
    public NodeData (Node workingNode, String name, Value value, int type)
            throws PathNotFoundException, RepositoryException  {
        this(workingNode,name,value);
    }
     ...
     * @throws RepositoryException
     */
    public NodeData (Node workingNode, String name, Value value)
            throws PathNotFoundException, RepositoryException  {
        this.dataFile = workingNode.addNode(name, ItemType.getSystemName(ItemType.NT_NODEDATA));
        Node contentNode = this.dataFile.addNode
                (ItemType.getSystemName(ItemType.JCR_CONTENT),
    ...
    /**
     * <p>Returns the <code>value</code> of this <code>NodeData</code>. One of type:
     * <ul>
    ...
    /**
     * <p>Returns the <code>String</code> representation of the value: <br>
    ...
    /**
     * <p>Returns the <code>String</code> representation of the value:
     * </p>
     *
     * @return String
     */
    ...
    /**
     * <p>Returns the <code>long</code> representation of the value:
     * </p>
     *
     * @return long
     */
    ...
    /**
     * <p>Returns the <code>double</code> representation of the value:
     * </p>
     *
     * @return double
     */
    ...
    /**
     * <p>Returns the <code>Calendar</code> representation of the value:
     * </p>
     *
     * @return Calendar
     */
    ...
    /**
     * <p>Returns the <code>boolean</code> representation of the value:
     * </p>
     *
     * @return boolean
     */
    ...
    /**
     * <p>Returns the <code>type</code> of this <code>NodeData</code>. One of:
     * <ul>
     * <li><code>PropertyType.STRING</code></li>
     * <li><code>PropertyType.DATE</code></li>
     * <li><code>PropertyType.SOFTLINK</code></li>
    ...
    public int getType () {
        ...
        } catch (Exception e) {return PropertyType.UNDEFINED; }
    }
    ...
    /**
     * <p>Access to property at the JCR level.
     * <br><b>available only to be available, should not be used in normal circunstances!</b>
     * </p>
     *
     * @return Property
     */
    ...
    /**
     * <p>set value of type <code>String</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>int</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>long</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>InputStream</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>double</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>boolean</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>Calendar</code></p>
     *
     * @throws RepositoryException
    ...
    /**
     * <p>set value of type <code>Value</code></p>
     *
     * @throws RepositoryException
     * @param value
     */
    ...
    /**
     * <p>checks if the atom exists in the repository</p>
     *
     * @return boolean
     */
    ...
    public boolean isGranted(long permissions) {
        try {
            return this.dataFile.isGranted(permissions);
