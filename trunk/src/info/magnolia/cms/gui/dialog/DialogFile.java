...
public class DialogFile extends DialogBox {
	...
	public DialogFile(ContentNode configNode,Content websiteNode) {
	...
	public void drawHtml(JspWriter out) {
		...
		try {
			...
			String htmlControlFileName="";
			htmlControlFileName+="<span class=\""+CSSCLASS_DESCRIPTION+"\">Filename</span>";
			htmlControlFileName+=spacer.getHtml(1);
			htmlControlFileName+=control.getHtmlFileName()+"<span id=\""+this.getName()+"_fileNameExtension\">."+control.getExtension()+"</span>";
