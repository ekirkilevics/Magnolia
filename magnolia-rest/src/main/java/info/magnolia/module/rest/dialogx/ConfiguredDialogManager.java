...
public class ConfiguredDialogManager extends ObservedManager {
    ...
    private void registerDialog(String name, final Content dialogConfigNode) {
        this.dialogs.put(name, dialogConfigNode);
        DialogRegistry.getInstance().registerDialog(name, new DialogProvider() {
            public Dialog create() {
                return ConfiguredDialogFactory.getInstance().createDialog(dialogConfigNode);
            }
        });
    }
