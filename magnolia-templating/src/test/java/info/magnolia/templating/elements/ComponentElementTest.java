 ...
 * @version $Id$
 */
public class ComponentElementTest extends AbstractElementTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        element = new ComponentElement(getServerCfg(), getContext(), getEngine(), getTemplateDefinitionAssignment());
    }
    ...
    public void testRenderBeginAll() throws Exception {
        // GIVEN
        getTemplateDefinition().setDialog("dialogNew");
        element.setContent(getComponentNode());
