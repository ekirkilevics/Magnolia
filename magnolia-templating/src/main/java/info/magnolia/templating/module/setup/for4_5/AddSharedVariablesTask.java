...
/**
 * Adds cms and cmsfn variables.
 *
 * @version $Id$
 */
public class AddSharedVariablesTask extends NodeBuilderTask {

    public AddSharedVariablesTask() {
        super(
                ...
                getNode("sharedVariables")
                        .then(addNode("cms", MgnlNodeType.NT_CONTENTNODE)
                                ...
                                addNode("cmsfn", MgnlNodeType.NT_CONTENTNODE)
                                        .then(addProperty(
                                                "class",
                                                info.magnolia.templating.functions.TemplatingFunctions.class .getName())))
        );
    }
}
