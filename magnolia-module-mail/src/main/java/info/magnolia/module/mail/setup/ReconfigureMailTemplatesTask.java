...
/**
 * Reconfigures email templates: moves "templates" to "templatesConfiguration" and renames the "body" property to "templateFile".
 *
 * @version $Id$
 */
class ReconfigureMailTemplatesTask extends AbstractRepositoryTask {
        ...
        public ReconfigureMailTemplatesTask(String name, String description, String workspaceName, String src, String dest, ItemType type, boolean overwrite) {
