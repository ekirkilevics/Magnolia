...
/**
 * This is a subclass of the regular MVCHandler to plug in flow events. In this case, only the activate method is part
 * of a flow. We should find a way to plug in flow on the different methods.
 * @author jackie
 * @authro Niko
 */
...
public abstract class FlowAdminTreeMVCHandler extends AdminTreeMVCHandler {
    ...
    public FlowAdminTreeMVCHandler(String name, HttpServletRequest request, HttpServletResponse response) {
