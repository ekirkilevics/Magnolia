...
public class OWFEBean {
    ...
    public void approveActivation(String expressionId, HttpServletRequest request) throws Exception {
        ...
        String path = ((StringAttribute) if_wi.getAttribute("pathSelected")).toString();
        boolean recursive = ((StringAttribute) if_wi.getAttribute("recursive")).equals("true");
    ...
    private void doActivate(HttpServletRequest request, String path, boolean recursive, boolean includeContentNodes)
        throws Exception {
