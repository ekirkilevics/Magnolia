...
/**
 * This is a copy of org.picocontainer.lifecycle.CompositeLifecycleStrategy,
 * where delegates are LifecycleStrategy[].
 *
 * @deprecated Should not be needed, as soon as PICO-381 is fixed.
 *
 * @author gjoseph
