...
/**
 * This interface defines all the methods which should be implemented by any configured
 * magnolia context, implementing class should never be accessible directly but only via
 * MgnlContext static methods which work on a local (Thread) copy of the implementation
...
public interface Context {
    ...
    /**
     * Attribute visibility scope
     * Shared by all requests from this session
     * */
    public static final int SESSION_SCOPE = 2;

    /**
     * Attribute visibility scope,
     * its visible to all sessions of this application
     * */
