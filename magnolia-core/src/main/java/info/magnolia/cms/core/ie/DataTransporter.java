...
public class DataTransporter {
    ...
    public static synchronized void executeImport(String basepath, String repository, File xmlfile,
                                                  boolean keepVersionHistory, int importMode, boolean saveAfterImport, boolean createBasepathIfNotExist) throws IOException {
        String fileName = xmlfile.getName();
        InputStream in = getInputStreamForFile(fileName, xmlfile);
        executeImport(basepath, repository, in, fileName, keepVersionHistory, importMode, saveAfterImport, createBasepathIfNotExist);
    }
    ...
    public static void executeExport(OutputStream baseOutputStream, boolean keepVersionHistory, boolean format, Session session, String basepath, String repository, String ext) throws IOException {
     ...
     */
    public static void parseAndFormat(OutputStream stream, XMLReader reader, String repository, String basepath, boolean format, Session session) throws Exception {
