...
/**
 * A primitive node data which is not supporting any operations being used for node datas of type BINARY. 
 * @author pbaerfuss
 * @version $Id$
 *
 */
public abstract class AbstractPrimitiveNodeData extends AbstractNodeData {
    
    private static Logger log = LoggerFactory.getLogger(AbstractPrimitiveNodeData.class);
    ...
    public AbstractPrimitiveNodeData(Content parent, String name) {
        super(parent, name);
    }
