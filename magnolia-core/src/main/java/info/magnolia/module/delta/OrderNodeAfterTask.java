...
public class OrderNodeAfterTask extends AbstractRepositoryTask {
    ...
    public OrderNodeAfterTask(String name, String description, String repository, String path, String orderAfterNodeName) {
        super(name, description);
        this.repository = repository;
        this.path = path;
        this.orderAfterNodeName = orderAfterNodeName;
    }

    @Override
    protected void doExecute(InstallContext installContext) throws RepositoryException, TaskExecutionException {
        final Content node = installContext.getHierarchyManager(repository).getContent(path);
        ContentUtil.orderAfter(node, orderAfterNodeName);
    }
