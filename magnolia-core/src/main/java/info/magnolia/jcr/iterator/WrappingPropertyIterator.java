...
public class WrappingPropertyIterator extends DelegatingPropertyIterator {
    ...
    public WrappingPropertyIterator(PropertyIterator iterator, PropertyWrapperFactory wrapperFactory) {
        super(iterator);
    ...
    @Override
    public Object next() {
        return wrapperFactory.wrapProperty((Property) super.next());
    }

    @Override
    public Property nextProperty() {
        return wrapperFactory.wrapProperty(super.nextProperty());
    }
}
