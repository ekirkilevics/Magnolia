 ...
 * @version $Id$
 */
public abstract class PropertyWrappingNodeWrapper extends ChildWrappingNodeWrapper implements PropertyWrapperFactory {

    public PropertyWrappingNodeWrapper(Node wrapped) {
        super(wrapped);
    }
