...
/**
 * Node wrapper that will reacquire the node using {@link LifeTimeJCRSessionUtil} if its session is closed.
 *
 * @version $Id$
 */
public class SystemNodeWrapper extends LazyNodeWrapper {

    public SystemNodeWrapper(String repository, String nodeIdentifier) {
        super(repository, nodeIdentifier);
    }
