 ...
 * Only return properties with a name that did not start with jcr: or mgnl:.
 */
public class JCRMgnlPropertiesFilteringNodeWrapper extends PropertyFilteringNodeWrapper {

    public JCRMgnlPropertiesFilteringNodeWrapper(Node wrapped) {
        super(wrapped, new JCRMgnlPropertyHidingPredicate());
    }
