...
public interface ChannelResolver {
    ...
    /**
     * @param request to retrieve channel from.
     *
     * @return name of the resolved channel or {@link info.magnolia.channel.ChannelResolver#UNRESOLVED} if it could not be resolved.
     */
