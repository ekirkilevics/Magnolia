...
/**
 * A PM which messures the time spent in saving. You must enable the PersistanceTestFilter
 * @author philipp
 * @version $Id$
 */
public class DerbyTestPersistanceManager extends DerbyPersistenceManager {
