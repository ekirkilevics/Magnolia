...
/**
 * Test case for {@link URIPatternVoter}.
 */
public class URIPatternVoterTest {

    @Test
    public void testVotesTrueOnMatchingWildcardPattern() {
        URIPatternVoter voter = new URIPatternVoter();
        voter.setPattern("/foo/bar*");
        assertEquals(1, voter.vote("/foo/bar/zed"));
    }
    ...
    public void testVotesFalseOnNonMatchingWildcardPattern() {
        URIPatternVoter voter = new URIPatternVoter();
        voter.setPattern("/foo/bar*");
        assertEquals(0, voter.vote("/abc/xyz"));
    }

    @Test
    public void testVotesFalseWhenNoPatternSet() {
        URIPatternVoter voter = new URIPatternVoter();
        assertEquals(0, voter.vote("/foo/bar"));
    }
}
