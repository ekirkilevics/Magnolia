...
public class TypeMappingImplTest {
    ...
    public void testGetPropertyTypeDescriptorWithCollection() {
        ...
        // WHEN
        PropertyTypeDescriptor ptd = mapping.getPropertyTypeDescriptor(BeanWithCollectionWithGenerics.class, "collection");
    ...
    public void testGetPropertyTypeDescriptorWithMap() {
        ...
        // WHEN
        PropertyTypeDescriptor ptd = mapping.getPropertyTypeDescriptor(BeanWithMapWithGenerics.class, "map");
