...
/**
 * Test case for {@link ContentDecoratorUtil}.
 *
 * @version $Id$
 */
public class ContentDecoratorUtilTest {
    ...
    public void returnsFalseWhenNotDecorated() {
        ...
        assertFalse(ContentDecoratorUtil.isDecoratedWith(node, ContentDecoratorSuperClass.class));
    }

    @Test
    public void returnsTrueWhenQueriedForExactClass() {
        Node node = new MockNode();
        node = new ContentDecoratorSuperClass().wrapNode(node);
        assertTrue(ContentDecoratorUtil.isDecoratedWith(node, ContentDecoratorSuperClass.class));
    }

    @Test
    public void returnsTrueWhenQueriedForSubClass() {
        Node node = new MockNode();
        node = new ContentDecoratorSubClass().wrapNode(node);
        assertTrue(ContentDecoratorUtil.isDecoratedWith(node, ContentDecoratorSuperClass.class));
    }
    ...
    public void returnsFalseWhenDecoratedByOtherDecorator() {
        Node node = new MockNode();
        node = new ContentDecoratorSuperClass().wrapNode(node);
        assertFalse(ContentDecoratorUtil.isDecoratedWith(node, ContentDecoratorSubClass.class));
    }
}
