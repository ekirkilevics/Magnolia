...
public class ModuleNodeBuilderTaskTest extends RepositoryTestCase {
    ...
    public void testModuleNodeIsCreatedIfNeeded() throws Exception {
        ...
        final ModuleNodeBuilderTask task = new ModuleNodeBuilderTask("Test", "Tests", ErrorHandling.strict,
        ...
        // then
        assertEquals("World", MgnlContext.getHierarchyManager("config").getNodeData("/modules/test-module/Hello").getString());
    }
