 ...
 */
public class PropertyValuesDeltaTest extends TestCase {
    ...
    public void testExistingPropertyIsReplaced() throws RepositoryException {
        ...
        final PropertyValuesDelta pvd = new DummyPropertyValuesDelta();

        replay(ctx);
        pvd.checkPropertyValue(ctx, node, "bar", "old-value", "newValue");
        verify(ctx);
    ...
    public void testNonExistingPropertyIsNotReplacedButLogged() throws RepositoryException {
        ctx.log("/foo/bar was expected to exist with value old-value but does not exist.");
    ...
    public void testPropertywithUnexpectedValueIsNotReplacedButLogged() throws RepositoryException {
        ctx.log("/foo/bar was expected to exist with value old-value but has the value wrong-value instead.");
    ...
    public void testUnexpectedlyExistingPropertyIsNotReplacedAndLogged() throws RepositoryException {
        ctx.log("/foo/bar was not expected to exist, but exists with value old-value and was going to be created with value newValue.");
    ...
    private static class DummyPropertyValuesDelta extends PropertyValuesDelta {
