...
public class BeanMergerUtilTest {
    ...
    public void testBeanMergerUtilProperlyHandsOverProvidedObjects() {
        final Object first2Merge = "a";
        final Object second2Merge = "b";
        List<Object> result = BeanMergerUtil.merge(first2Merge, second2Merge);

        assertEquals(result.get(0), first2Merge);
        assertEquals(result.get(1), second2Merge);
    }
}
