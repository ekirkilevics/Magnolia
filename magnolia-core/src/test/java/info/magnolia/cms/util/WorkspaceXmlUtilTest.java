...
public class WorkspaceXmlUtilTest {
    ...
    @Before
    public void setUp() {
        SystemProperty.setProperty(SystemProperty.MAGNOLIA_REPOSITORIES_HOME, "src/test/resources/config/repositories");
    }
    ...
    public void testWorkspaceNamesWithNullExpectation() {
        ...
        assertEquals("Found incorrect amount of indexers", 1, names.size());
        assertTrue(names.get(0).contains("/current/workspace.xml"));
    }
