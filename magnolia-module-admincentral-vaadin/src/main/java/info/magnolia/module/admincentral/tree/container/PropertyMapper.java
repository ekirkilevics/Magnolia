...
/**
 * Maps object values to Jcr-Properties and vice versa.
 *
 * @author daniellipp
 * @version $Id$
 */
...
public class PropertyMapper {
     ...
     * @param id - String identifier of the Property to be set
     * @param val - Object value of the Property to be set
     * @throws ValueFormatException
