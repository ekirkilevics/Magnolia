 ...
 * @version $Id$
 */
public class ExtensionVariationResolverTest extends AbstractMagnoliaTestCase {

    public ConfiguredTemplateDefinition templateDefinition;
    ...
    @Test
    public void testChoosesVariantWhenExtensionMatch() throws Exception {

        MockWebContext mockContext = (MockWebContext) MockUtil.initMockContext();
        mockContext.getAggregationState().setExtension("xml");
    ...
    @Test
    public void testChoosesTemplateWhenExtensionDoesntMatch() throws Exception {

        MockWebContext mockContext = (MockWebContext) MockUtil.initMockContext();
        mockContext.getAggregationState().setExtension("pdf");
