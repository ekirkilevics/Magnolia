 ...
 * @version $Id$
 */
public class RolesTreeHandler extends AdminTreeMVCHandler {
     ...
     * @param response
     */
    public RolesTreeHandler(String name, HttpServletRequest request, HttpServletResponse response) {
        super(name, request, response);
        this.setConfiguration(new RolesTreeConfiguration());
    }
