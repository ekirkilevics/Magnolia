...
/**
 * @deprecated This class should NOT exist. All the mothods should be moved to the Group or User interface.
 */
public class JCRUserUtil {
	 ...
	 * Logger
	 */
	private static Logger log = LoggerFactory.getLogger(JCRUserUtil.class);
