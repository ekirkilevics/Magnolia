...
public class AdminModuleVersionHandlerTest extends ModuleVersionHandlerTestCase {
    ...
    public void testWarnsIfDefaultUriIsQuickstartOnPublicAndTemplatesExist() throws ModuleManagementException, RepositoryException {
        ...
        // fake user dialog password field
        setupConfigProperty("/modules/adminInterface/dialogs/useredit/tabUser/pswd", "controlType", "password");
        // fake user preferences dialog password field
        setupConfigProperty("/modules/adminInterface/dialogs/userpreferences/tabUser/pswd", "controlType", "password");
