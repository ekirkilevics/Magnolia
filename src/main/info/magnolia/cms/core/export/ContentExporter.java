...
public class ContentExporter {
     ...
     * */
    public final static String DEFAULT_HANDLER_CLASS = "info.magnolia.cms.core.export.XmlExport";
    ...
    private ContentExporter () {
        try {
            Export defaultExporter= (Export) Class.forName(DEFAULT_HANDLER_CLASS).newInstance();
    ...
    public void addExportHandler(String name, Export export) {
    ...
    public Export getExportHandler(String name) {
        ...
        return (Export) this.handlers.get(name);
    }
