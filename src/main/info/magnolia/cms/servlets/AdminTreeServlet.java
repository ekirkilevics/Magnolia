...
public class AdminTreeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (actionStr != null) {
            ...
            if (action == Tree.ACTION_COPY || action == Tree.ACTION_MOVE) {
                ...
                if (pasteType == Tree.PASTETYPE_SUB)
                    ...
                    pathOpen = pathSelected.substring(0, pathSelected.lastIndexOf("/")); // open parent path of
                // destination path
        ...
        if (request.getParameter("isNodeDataValue") != null && request.getParameter("isNodeDataValue").equals("true"))
            isNodeDataValue = true;
        if (request.getParameter("isNodeDataType") != null && request.getParameter("isNodeDataType").equals("true"))
            isNodeDataType = true;
        ...
        if (saveName != null || isNodeDataValue || isNodeDataType) {
            ...
            if (request.getParameter("isMeta") != null && request.getParameter("isMeta").equals("true"))
                isMeta = true;
            if (request.getParameter("isLabel") != null && request.getParameter("isLabel").equals("true"))
                isLabel = true;
            ...
            // html will be displayed in the span as new value! therefore be carefull that treesIFrame.jsp does not
            // create any white spaces!
            // out.write(html);
        ...
        if (proceed) {
            ...
            if (!snippetMode) {
                ...
                html
                    .append("<body class=\"mgnlBgDark\" onload=\"mgnlTree.resizeOnload();\" marginwidth=\"0\" marginheight=\"0\" leftmargin=\"0\" topmargin=\"0\">");
            ...
            if (repository.equals(ContentRepository.WEBSITE)) {
                ...
                menuActivateExcl.setOnclick(websiteTree.getJavascriptTree()
                    + ".activateNode("
                ...
                menuActivateIncl.setOnclick(websiteTree.getJavascriptTree()
                    + ".activateNode("
                    + Tree.ACTION_ACTIVATE
                    + ",true);");
                ...
                menuDeActivate.setOnclick(websiteTree.getJavascriptTree()
                    + ".deActivateNode("
                    + Tree.ACTION_DEACTIVATE
                    + ");");
                ...
                html.append(websiteTree.getHtml()); // print, not println! because of snippet mode!
                if (!snippetMode) {
                    html.append("</div>");
                }
            ...
            if (repository.equals(ContentRepository.USERS)) {
                ...
                if (Server.isAdmin())
                    usersTree.setIconOndblclick("mgnlTreeMenuOpenDialog("
                ...
                menuNewPage.setOnclick(usersTree.getJavascriptTree()
                    + ".createRootNode('"
                    + ItemType.NT_CONTENT
                    + "');");
                ...
                menuActivateExcl.setOnclick(usersTree.getJavascriptTree()
                    + ".activateNode("
                    + Tree.ACTION_ACTIVATE
                    + ",false);");
                menuActivateExcl.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                menuDeActivate.setOnclick(usersTree.getJavascriptTree()
                    + ".deActivateNode("
                    + Tree.ACTION_DEACTIVATE
                    + ");");
                menuDeActivate.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                html.append(usersTree.getHtml()); // print, not println! because of snippet mode!
                if (!snippetMode) {
                    html.append("</div>");
                }
            }
            ...
            if (repository.equals(ContentRepository.USER_ROLES)) {
                ...
                if (Server.isAdmin()) {
                    rolesTree.setIconOndblclick("mgnlTreeMenuOpenDialog("
                ...
                menuNewPage.setOnclick(rolesTree.getJavascriptTree()
                    + ".createRootNode('"
                    + ItemType.NT_CONTENT
                    + "');");
                ...
                menuActivateExcl.setOnclick(rolesTree.getJavascriptTree()
                    + ".activateNode("
                    + Tree.ACTION_ACTIVATE
                    + ",false);");
                menuActivateExcl.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                menuDeActivate.setOnclick(rolesTree.getJavascriptTree()
                    + ".deActivateNode("
                    + Tree.ACTION_DEACTIVATE
                    + ");");
                menuDeActivate.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                html.append(rolesTree.getHtml()); // print, not println! because of snippet mode!
                if (!snippetMode) {
                    html.append("</div>");
                }
            }
            ...
            if (repository.equals(ContentRepository.CONFIG)) {
                ...
                /*
                 * //dev TreeColumn column3=new TreeColumn(configTree.getJavascriptTree());
                 * column3.setName(MetaData.SEQUENCE_POS); column3.setIsMeta(true); column3.setWidth(2);
                 * column3.setTitle("SEQ_POS"); configTree.addColumn(column3);
                 */
                ...
                menuNewContentNode.setOnclick(configTree.getJavascriptTree()
                    + ".createNode('"
                ...
                menuNewNodeData.setOnclick(configTree.getJavascriptTree()
                    + ".createNode('"
                    + ItemType.NT_NODEDATA
                    + "');");
                ...
                menuActivateExcl.setOnclick(configTree.getJavascriptTree()
                    + ".activateNode("
                    + Tree.ACTION_ACTIVATE
                    + ",false);");
                menuActivateExcl.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                menuActivateIncl.setOnclick(configTree.getJavascriptTree()
                    + ".activateNode("
                    + Tree.ACTION_ACTIVATE
                    + ",true);");
                menuActivateIncl.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                TreeMenuItem menuDeActivate = new TreeMenuItem();
                menuDeActivate.setLabel("De-activate");
                menuDeActivate.setOnclick(configTree.getJavascriptTree()
                    + ".deActivateNode("
                    + Tree.ACTION_DEACTIVATE
                    + ");");
                menuDeActivate.addJavascriptCondition("mgnlTreeMenuItemConditionSelectedNotRoot");
                ...
                if (!snippetMode) {
                    html.append("<div id="
                        + configTree.getJavascriptTree()
                        + "_DivSuper style=\"display:"
                        + display
                        + ";\">");
                }
                html.append(configTree.getHtml()); // print, not println! because of snippet mode!
                if (!snippetMode) {
                    html.append("</div>");
                }
            }
