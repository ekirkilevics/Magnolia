...
public class Tree extends ControlSuper
{
     ...
     * </p>
     * <p>
     * "_EXPAND" in file name will be replaced by "_COLLAPSE" after expanding
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * "_COLLAPSE" in file name will be replaced by "_EXPAND" after collapsing
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * "_EMPTY" in the file name will be replaced when children are available
     * </p>
     * <p>
     * e.g. myShifterIcon_EMPTY.gif
     * </p>
     * @param src source of the image
     */
    ...
    public String getHtmlFooter()
    {
        ...
        if (this.getMenuItems().size() != 0)
        {
            ...
            for (int i = 0; i < this.getMenuItems().size(); i++)
            {
                ...
                {
                    html
                        .append("<div class=\"mgnlTreeMenuLine\"><img src=\"/admindocroot/0.gif\" width=\"1\" height=\"1\"></div>");
                }
                else
                {
        ...
        html
            .append("<div id=\""
                + this.getJavascriptTree()
                + "_MoveShadow\" style=\"position:absolute;top:0px;left:0px;visibility:hidden;background-color:#ffffff;\"></div>");
        ...
        try
        {
            ...
            while (it.hasNext())
            {
                ...
                if (itemType.equals(ItemType.NT_NODEDATA))
                {
                    ...
                    handle = d.getHandle();
                    name = d.getName();
                    if (d.isGranted(info.magnolia.cms.beans.runtime.Permission.ALL_PERMISSIONS))
                ...
                else
                {
                    ...
                    if (c.isGranted(info.magnolia.cms.beans.runtime.Permission.ALL_PERMISSIONS))
                        permissionWrite = true;
                    if (c.getAncestor(c.getLevel() - 1).isGranted(
                        info.magnolia.cms.beans.runtime.Permission.ALL_PERMISSIONS))
