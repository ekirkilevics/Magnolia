...
public class VirtualMap {
    ...
    public void update(String configPath) {
        ...
        try {
            ...
            ContentNode mappingNode = configHierarchyManager.
                    getContentNode(configPath);
    ...
    /**
     * <p>
     * checks for the requested URI mapping in Server config
     * : Servlet Specification 2.3 Section 10 "Mapping Requests to Servlets"
     * </p>
     *
