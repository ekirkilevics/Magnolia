...
public class ContentRepository {
    ...
    /**
     * <p>
     * loads all configured repository using ID as Key, as configured in repositories.xml<br>
     *  <Repository name="website" id="website" provider="info.magnolia.jackrabbit.ProviderImpl" loadOnStartup="true" >
     *      <param name="configFile" value="../webapps/magnolia/WEB-INF/config/repositories/website.xml"/>
     *      <param name="repositoryHome" value="../webapps/magnolia/repositories/website"/>
      ...
      Document document = buildDocument();
        ...
        while (children.hasNext()) {
            ...
            while (params.hasNext()) {
                ...
                parameters.put((String)param.getAttributeValue(ATTRIBUTE_NAME),
                        (String)param.getAttributeValue(ATTRIBUTE_VALUE));
            }
     ...
     * Note : this hierarchyManager is created with system rights and has full access on
