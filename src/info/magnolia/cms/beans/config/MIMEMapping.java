...
public class MIMEMapping {
    ...
    /**
     * <p>reads all configured mime mapping (config/server/MIMEMapping)</p>
     *
     */
    public static void init() {
        ...
        try {
            ...
            Content startPage
                    = ContentRepository.getHierarchyManager(ContentRepository.CONFIG).getPage(START_PAGE);
    ...
    /**
     * <p>Cache all MIME types configured</p>
     *
     */
    private static void cacheContent() {
        while (MIMEMapping.MIMEList.hasNext()) {
            ...
            try {
                MIMEMapping.cachedContent.put(c.getNodeData("extension").getString(),c.getNodeData("mime-type").getString());
            } catch (Exception e) {log.error("Failed to cache MIMEMapping");}
        }
