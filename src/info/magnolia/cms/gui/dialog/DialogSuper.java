...
public class DialogSuper implements DialogInterface {
	...
	public static final String CSSCLASS_EDITWITHBUTTON="dialogEditWithButton";
	...
	public void setConfig(Content configNodeParent) {
		...
		Iterator itProps=configNodeParent.getChildren(ItemType.MAGNOLIA_NODE_DATA).iterator();
		...
		Iterator it=configNodeParent.getChildren(ItemType.MAGNOLIA_CONTENT_NODE).iterator();
		while (it.hasNext()) {
