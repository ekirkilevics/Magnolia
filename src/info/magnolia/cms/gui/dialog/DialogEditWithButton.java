...
public class DialogEditWithButton extends DialogBox {
	...
	public DialogEditWithButton(ContentNode configNode,Content websiteNode) {
	...
	public Button getButton() {return this.getButton(0);}
	public Button getButton(int index) {return (Button) this.getButtons().get(index);}



	public void setButtons(ArrayList l) {this.buttons=l;}
	...
	public void drawHtml(JspWriter out) {
		...
		try {
			...
			if (this.getConfigValue("buttonLabel",null)!=null) this.getButton().setLabel(this.getConfigValue("buttonLabel"));
