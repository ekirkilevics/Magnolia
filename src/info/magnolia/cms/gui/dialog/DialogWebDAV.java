...
public class DialogWebDAV extends DialogBox {
	...
	private String host="ical.obinary.com";
	private int port=0;
	//todo: webdav config!!!!! (now all values are static...)
	private String directory="/ical/";
	private String subDirectory="";
	private String user="ical";
	private String password="alibaba55";
