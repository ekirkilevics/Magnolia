...
public class File extends ControlSuper {
	...
	public String getFileName() {
		String fileName="";
		try {
			fileName=this.getWebsiteNode().getContentNode(this.getName()+"_"+FileProperties.PROPERTIES_CONTENTNODE).getNodeData(FileProperties.PROPERTY_FILENAME).getString();
		}
		catch (Exception e) {}
		return fileName;
	}
	...
	public String getNodeDataTemplate() {
		...
		if (template==null) {
			try {
				template=this.getWebsiteNode().getContentNode(this.getName()+"_"+FileProperties.PROPERTIES_CONTENTNODE).getNodeData(FileProperties.PROPERTY_TEMPLATE).getString();
			}
			catch (Exception e) {}
		}
		return template;
	...
	public String getExtension() {
		String ext="";
		try {
			ext=this.getWebsiteNode().getContentNode(this.getName()+"_"+FileProperties.PROPERTIES_CONTENTNODE).getNodeData(FileProperties.PROPERTY_EXTENSION).getString();
		}
		catch (Exception e) {}
		return ext;
	}
