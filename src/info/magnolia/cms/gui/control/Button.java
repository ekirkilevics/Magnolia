...
public class Button extends ControlSuper {
	...
	public String getHtml() {
		...
		if (this.getButtonType()==BUTTONTYPE_PUSHBUTTON) html.append(this.getHtmlPushbutton());
		else html.append(this.getHtmlDividedbutton());
	...
	public String getHtmlDividedbutton() {
		...
		if (!this.getOnclick().equals("")) html.append(" onclick=\""+this.getOnclick()+"\"");
		if (this.getState()==BUTTONSTATE_PUSHED) html.append(" checked");
		...
		html.append("<a href=\"javascript:mgnlShiftDividedButton('"+this.getId()+"');"+this.getOnclick()+"\" "+this.getHtmlCssClass()+">");
