...
################################### */
	...
	mgnlTree.prototype.moveNodeHighlightLine = function(divId)
		...
		if (mgnlTreeMoveNode)
			...
			div.style.backgroundImage="url(/admindocroot/controls/tree/line_internode.gif)";
			this.divMoveDenied.style.visibility="hidden";
	...
	function mgnlTreeMenuItemConditionSelectedNotNodeData(tree)
		{
		if (tree.selectedNode.itemType!="NT_NodeData") return true;
		else return false;
		}

	function mgnlTreeMenuItemConditionSelectedNotContentNode(tree)
		{
		if (tree.selectedNode.itemType!="NT_ContentNode") return true;
		else return false;
		}

	function mgnlTreeMenuItemConditionSelectedNotContent(tree)
		{
		if (tree.selectedNode.itemType!="NT_Content") return true;
		else return false;
		}
