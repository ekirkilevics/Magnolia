...
<a href="mailto:${license.ProviderEmail}">${license.ProviderEmail}</a>
    ...
    <div class="framediv"><iframe
        src="http://www.magnolia.info/en/admincentral/aboutmagnolia.html?magnoliaVersion=${license.VersionNumber}&amp;amp;magnoliaBuild=${license.BuildNumber}&amp;amp;serverOS=${license.OSName}&amp;amp;isAdmin=${isadmin}">
    </iframe></div>
