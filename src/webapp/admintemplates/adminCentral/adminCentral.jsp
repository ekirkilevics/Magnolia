<jsp:root version="1.2" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:c="urn:jsptld:http://java.sun.com/jsp/jstl/core"
    ...
    <div id="mgnlAdminCentral_ExtractTreeDiv" class="mgnlAdminCentralExtractTreeDiv"><iframe
        ...
        style="border: none; width:100%; height:100%"><!-- a comment here is needed for the correct rendering of the iframe tag --></iframe>
    </div>
    ...
    <!-- a comment here is needed for the correct rendering of the iframe tag --></iframe></div>
    </body>
    </html>
</jsp:root>
