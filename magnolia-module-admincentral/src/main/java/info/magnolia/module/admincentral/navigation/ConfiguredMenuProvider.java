 ...
 */
public class ConfiguredMenuProvider implements MenuProvider {

    private Content configNode;

    public ConfiguredMenuProvider(Content configNode) {
    ...
    public MenuDefinition getMenuDefinition() throws RepositoryException {
        try {
            MenuDefinition definition = (MenuDefinition) Content2BeanUtil.toBean(configNode, true, MenuDefinition.class);
            return definition;
