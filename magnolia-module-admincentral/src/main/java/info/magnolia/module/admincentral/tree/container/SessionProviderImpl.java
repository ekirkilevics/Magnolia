...
/**
 * Provides a Session for the kept repository.
 *
 * @author daniellipp
 * @version $Id$
 */
public class SessionProviderImpl implements JcrSessionProvider {

    private static final long serialVersionUID = 7610051801740656400L;

    private String repository;

    public SessionProviderImpl(String repository) {
        super();
