 ...
 * @deprecated since 4.5, replaced by {@link info.magnolia.rendering.renderer.RenderingModelBasedRenderer}
 */
public interface RenderingModelBasedRenderer {

    RenderingModel newModel(Content content, RenderableDefinition definition, RenderingModel parentModel) throws RenderException;
}
