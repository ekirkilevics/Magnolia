...
/**
 * TODO naming, package?
 * A base custom component comprising a text field and a button placed to its immediate right.
 * @author fgrilli
 *
 */
public class TextFieldAndButtonComponent extends CustomComponent implements Field {

    private TextField field;
    private Button button;

    public TextFieldAndButtonComponent() {
        field = new TextField();
        button = new Button();
