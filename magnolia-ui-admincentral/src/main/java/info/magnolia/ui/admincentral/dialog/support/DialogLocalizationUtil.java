 ...
 *
 */
package info.magnolia.ui.admincentral.dialog.support;
...
/**
 * Utility for resolving messages on dialog entities.
 */
public class DialogLocalizationUtil {

    public static Messages getMessages(DialogDefinition dialogDefinition) {
    ...
    public static Messages getMessages(DialogDefinition dialogDefinition, TabDefinition tabDefinition) {
    ...
    public static Messages getMessages(DialogDefinition dialogDefinition, TabDefinition tabDefinition, FieldDefinition fieldDefinition) {
