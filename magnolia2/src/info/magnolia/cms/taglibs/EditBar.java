...
public class EditBar extends TagSupport {
    ...
    /**
     * <p>set the edit label (else "Edit")</p>
     *
    ...
    /**
     * <p>set the delete label (else "Delete")</p>
     *
     * @param label , under which content must be stored
     */
    ...
    private void display() throws IOException {
		...
		if (this.getEditLabel()!=null) {
			if (this.getEditLabel().equals("")) bar.setButtonEdit(null);
			else bar.getButtonEdit().setLabel(this.getEditLabel());
		}
		if (this.getMoveLabel()!=null) {
			if (this.getMoveLabel().equals("")) bar.setButtonMove(null);
			else bar.getButtonMove().setLabel(this.getMoveLabel());
		}
		if (this.getDeleteLabel()!=null) {
			if (this.getDeleteLabel().equals("")) bar.setButtonDelete(null);
			else bar.getButtonDelete().setLabel(this.getDeleteLabel());
		}
