...
CodePress = function(obj) {
    ...
    if(self.textarea.style.width.length==0)
    ...
    self.initialize = function() {
        ...
        self.editor.body = self.contentWindow.document
    ...
    self.edit = function(obj, language) {
        if (obj)
            self.textarea.value = document.getElementById(obj) ? document
                    .getElementById(obj).value : obj;
    ...
    self.setOptions = function() {
        if (self.options.match('autocomplete-off'))
            self.toggleAutoComplete();
        if (self.options.match('readonly-on'))
            self.toggleReadOnly();
        if (self.options.match('linenumbers-off'))
    ...
    self.toggleLineNumbers = function() {
        ...
        self.editor.body.className = (cn == '' || cn == 'show-line-numbers') ? 'hide-line-numbers'
                : 'show-line-numbers';
    }
