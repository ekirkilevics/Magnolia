...
public class TypeDialog extends ConfiguredDialog {
    ...
    protected String configureDialog(Content type) throws RepositoryException {
        ...
        if (!type.hasContent("dialogs")) {
            ...
            ContentRepository.getRepositoryProvider(getRepository()).registerNodeTypes(
                new ByteArrayInputStream(NODE_TYPE_DEF_TEMPLATE.format(new String[]{type.getName()}).getBytes()));
            type.save();
        }
        else {
    ...
    protected void configureTree(Content type, String dialogName) throws AccessDeniedException, PathNotFoundException,
        RepositoryException {
