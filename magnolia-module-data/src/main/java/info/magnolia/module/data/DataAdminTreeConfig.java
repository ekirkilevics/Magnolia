 ...
 */
public class DataAdminTreeConfig implements AdminTreeConfiguration {
    ...
    public void prepareTree(Tree tree, boolean browseMode, HttpServletRequest request) {
        ...
        tree.setIconOndblclick("mgnl.data.TypeTree.show(" + tree.getJavascriptTree() + ")");
        ...
        colDate.setWidth(1);
        colDate.setTitle(msgs.get("data.list.date"));
    ...
    public void prepareContextMenu(Tree tree, boolean browseMode, HttpServletRequest request) {
        ...
        ContextMenuItem menuNewType = new ContextMenuItem("newType");
        menuNewType.setLabel(msgs.get("data.menu.newType"));
        menuNewType.setIcon(request.getContextPath() + "/.resources/icons/16/document_add.gif");
        menuNewType.setOnclick("mgnl.data.TypeTree.createNew(" + tree.getJavascriptTree() + ".selectedNode.id);");
        ...
        menuEditType.setLabel(msgs.get("data.menu.edit"));
        ...
        menuEditType.setOnclick("mgnlTreeMenuOpenDialog("
            + tree.getJavascriptTree()
            + ",'.magnolia/dialogs/typeDialog.html');");
        ...
        // menuDownloadDocument.setOnclick("mgnl.dms.DMS.downloadFile(" + tree.getJavascriptTree() +
        // ".selectedNode.id);");
        ...
        menuVersions.setLabel(msgs.get("data.menu.versions"));
    ...
    public void prepareFunctionBar(Tree tree, boolean browseMode, HttpServletRequest request) {
        ...
        bar.addMenuItem(new FunctionBarItem(menu.getMenuItemByName("newType")));
